...
'AidIQ Project Management': 'AidIQ Project Management',
'AidIQ Project Management Tool': 'AidIQ Project Management Tool',
'AidIQ Projects': 'AidIQ Projects',
...
'Budget Line Utilisation': 'Budget Line Utilisation',
...
'Calculate': 'Calculate',
'Calendar not configured in models/000_config.py': 'Calendar not configured in models/000_config.py',
'Camp': 'Camp',
...
"If you don't see the Customer in the list, you can add a new one by clicking link 'Add Customer'.": "If you don't see the Customer in the list, you can add a new one by clicking link 'Add Customer'.",
...
'If you need an account, then please %(sign_up_now)s': 'If you need an account, then please %(sign_up_now)s',
...
'Import Project Sites': 'Import Project Sites',
...
'No Customers currently registered': 'No Customers currently registered',
'No Date': 'No Date',
...
'Project Income Allocation': 'Project Income Allocation',
...
'Search for a Task by description.': 'Search for a Task by description.',
...
'Search for an Customer by name or acronym': 'Search for an Customer by name or acronym',
