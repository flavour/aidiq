...
class contact():
    ...
    def __call__(self):
        ...
        form = DIV(
                H1("Contact Us"),
                P("We'd love to hear from you. You can send us a message using the form below."),
                FORM(TABLE(
                        TR(LABEL("Your name:",
                              SPAN(" *", _class="req"),
                              _for="name")),
                        TR(INPUT(_name="name", 
                                 ...
                                 _size=62, 
                                 _maxlength="255", 
                                 _placeholder="Joe Smith")),
                        TR(LABEL("Your e-mail address:",
                              SPAN(" *", _class="req"),
                              _for="address")),
                        TR(INPUT(_name="address", 
                                 _type="text", 
                                 _size=62, 
                                 _maxlength="255",
                                 _placeholder="joe.smith@example.com")),
                        TR(LABEL("Subject:",
                              SPAN(" *", _class="req"),
                              _for="subject")),
                        ...
                        TR(INPUT(_type="submit", _value="Send e-mail", _class="small primary button")),
                        ),
                    _id="mailform"
                    )
                )
