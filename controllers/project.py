...
# =============================================================================
def timeline():
    """ Show the Project Calendar as a Simile Timeline """

    calendar = deployment_settings.project.calendar
    if not calendar:
        response.error = T("Calendar not configured in models/000_config.py")
        calendar = ""
    ...
    #s3.scripts.append("http://simile.mit.edu/timeline/api/timeline-api.js")
...
$(window).resize(function() {
    ...
    output = dict(title=title, item=item)
